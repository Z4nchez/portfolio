...
function Header() {
  ...
  const vHM1 = {
    open: { background: "linear-gradient(225deg, rgba(0, 0, 0, 0.9) 80%, transparent 20%)", fontSize: "0.6rem" },
    closed: { background: "linear-gradient(225deg, transparent 80%, transparent 20%)", fontSize: "0.7rem" },
  }
  const vL = {
    open: {  color: "white" },
    closed: { color: "black" },
